...
const uint8_t leds_list[4] = { 6, 22, 23, 24 };
...
int main(void)
{
    ...
    do { uint32_t pin; for (pin = 0; pin < 32; pin++) if ( (((1<<6) | (1<<22) | (1<<23) | (1<<24))) & (1 << pin) ) nrf_gpio_cfg_output(pin); } while (0);
